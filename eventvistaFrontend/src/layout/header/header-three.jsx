              ...
              <div className="tp-mobile-bar d-flex align-items-center justify-content-end">
                <div className="tp-bt-btn-banner d-none d-md-block d-xl-none mr-30">
                  <a className="tp-bt-btn" href="tel:123456">
                    ...
                    >
                      <circle cx="2" cy="2" r="2" fill="#7B1717" />
                      <circle cx="7" cy="2" r="2" fill="#7B1717" />
                      <circle cx="12" cy="2" r="2" fill="#7B1717" />
                      <circle cx="12" cy="7" r="2" fill="#7B1717" />
                      <circle cx="12" cy="12" r="2" fill="#7B1717" />
                      <circle cx="7" cy="7" r="2" fill="#7B1717" />
                      <circle cx="7" cy="12" r="2" fill="#7B1717" />
                      <circle cx="7" cy="17" r="2" fill="#7B1717" />
                      <circle cx="2" cy="7" r="2" fill="#7B1717" />
                      <circle cx="2" cy="12" r="2" fill="#7B1717" />
                    </svg>
