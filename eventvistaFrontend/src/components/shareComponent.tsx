import { ShareComponentProps } from "@/types_and_interfaces/types";
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body className="modal-body pt-40 pb-40 d-flex justify-content-center">
          <div className="text-center ">
            <div
              className="profileicons d-flex justify-content-around detailed-share-icons-main-div"
              style={{ width: "90%" }}
            >
              <div className="icon-div m-3">
                <Link
                  href={facebookShare}
                  target="_blank"
                  id="facebook-share"
                ...
                >
                  <i
                    style={{ fontSize: "27px", color: "#7B1717" }}
              ...
              <div className="icon-div m-3">
                ...
                >
                  ...
                  >
                    <g clip-path="url(#clip0_171_2630)">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
              ...
              <div className="icon-div m-3 detailed-linked-in-id">
                <Link
                  href={twitterShare}
                  target="_blank"
                  id="twitter-share"
