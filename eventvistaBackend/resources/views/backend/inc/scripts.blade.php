...
<script>
    ...
    $(function() {
        ...
        $(".time-picker").each(function(el) {
            var $this = $(this);
            var options = {
                enableTime: true,
                noCalendar: true,
                dateFormat: "h:i K", // Format for displaying time with AM/PM
                time_24hr: false, // Set to true for 24-hour format, false for 12-hour format
            };

            var time = $this.data("time");

            if (time) {
                options.defaultDate = time;
            }
