                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_event_spaces_coupon')
                                    <a href="{{ route('admin.events.coupons.create') }}" class="btn btn-primary"><i
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown tt-tb-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @can('edit_event_spaces_coupon')
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.events.coupons.edit', ['id' => $coupon->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                            <i data-feather="edit-3" class="me-2"></i>{{ localize('Edit') }}
                                                        </a>
                                                    @endcan

                                                    @can('remove_event_spaces_coupon')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('admin.events.coupons.delete', $coupon->id) }}"
