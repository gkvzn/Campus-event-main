                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                @can('add_categories')
                                    <a href="{{ route('admin.events.categories.create') }}" class="btn btn-primary"><i
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_categories')
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.events.categories.edit', ['id' => $category->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                    ...
                                                    @can('delete_categories')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('admin.events.categories.delete', $category->id) }}"
